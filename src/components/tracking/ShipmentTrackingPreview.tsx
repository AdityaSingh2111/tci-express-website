...
export function ShipmentTrackingPreview() {
  return (
    <SectionContainer className="bg-[#000000]">
      <SectionHeader
      ...
      <div className="mt-10 max-w-2xl mx-auto">
        ...
        <div className="mt-10 pt-8 border-t border-[#333333]">
          <h3 className="text-white text-sm font-bold mb-4 text-center tracking-wide uppercase">
            How Status Tracking Works
          </h3>
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center" role="list">
            <li className="text-white/70 text-xs leading-relaxed">
              <span className="block text-sm font-semibold text-white mb-1.5">1. Dispatch</span>
              Cargo loaded and secure LR generated.
            </li>
            <li className="text-white/70 text-xs leading-relaxed">
              <span className="block text-sm font-semibold text-white mb-1.5">2. In Transit</span>
              Live GPS updates directly from our fleet.
            </li>
            <li className="text-white/70 text-xs leading-relaxed">
              <span className="block text-sm font-semibold text-white mb-1.5">3. Delivery</span>
