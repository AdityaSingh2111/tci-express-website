  ...
  return (
    ...
    >
      ...
      <div className="p-5 md:p-6 pt-2 md:pt-6">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#FEF2F2] text-brand-red text-[11px] font-bold tracking-wide uppercase mb-3">
        ...
        <h3 id="promo-title" className="text-xl md:text-lg font-bold text-background-dark leading-snug mb-2 tracking-[-0.01em]">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          <Link
            href="/quote"
            onClick={dismiss}
            className="flex items-center justify-center w-full px-5 py-3.5 md:py-2.5 bg-brand-blue text-white text-[15px] md:text-sm font-bold md:font-semibold rounded-xl md:rounded-lg shadow-md hover:bg-[#0047B3] hover:shadow-lg transition-all focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-blue active:scale-[0.98] md:active:scale-100"
          >
            Get Free Quote
          </Link>
