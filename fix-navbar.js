...
const startIdx = code.indexOf('// Desktop CTAs') !== -1 ? code.indexOf('// Desktop CTAs') : code.indexOf('Desktop CTAs');
const endIdx = code.indexOf('// Body scroll lock') !== -1 ? code.indexOf('// Body scroll lock') : code.indexOf('Body scroll lock');

if (startIdx !== -1 && endIdx !== -1) {
  const newBlock = `Desktop CTAs -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- */}
...
`;
  ...
  // Wait, I actually need to make sure I don't accidentally drop the hook!
  // The 'Body scroll lock' is inside useEffect which is currently inside the `className` because of my accidental replacement!
  // It's completely broken!
  
  console.log("I need to rethink this replacement.");
}
